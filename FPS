...
<head>
    ...
    <title>2022CHEY FPS GAMES 开启！</title>
				...
				<div class="content">
					<div class="content-top">				
							...
							<ul>
								...
								<li>
									<a href="https://download.csdn.net/download/Chey_LER_SLC/85523789?spm=1001.2014.3001.5501" target="_blank"><i>点击此处 打开下载地点 （即刻跳转）</i></a>
									
								<span></span></li>

								<li>
									<a href="https://blog.csdn.net/Chey_LER_SLC?spm=1010.2135.3001.5421" target="_blank"><i>备用地址 1 （从主页进入下载界面）</i></a>
									
								<span></span></li>
								
								<li>
								
								<i>Developed by CHEY STUDIO</i>
